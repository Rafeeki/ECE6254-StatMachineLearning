...
# alpha = .001 - step-size chosen from Hessian Matrix for Netwon-Raphson method
tol = 1e-3
maxiter = 10000
theta,cost,iters = grad_desc(theta,xtilde,y,tol,maxiter)
...
plt.title("Logistic regression classifier converged in " + str(iters) + " iterations")
plt.show()
print("Final cost = %.6f" % cost[-1])
for c in cost:
    print c